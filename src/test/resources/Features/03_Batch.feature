...
Feature: Batch Module
  ...
  Scenario Outline: Check user able to Get all batch details
    ...
    Then User receives <statusCode> and with response body for get all batches
  ...
  Scenario Outline: Check user able to Get batch details by batch id
    ...
    Then User receives <statusCode> and with response body for get by batch Id
   ...
   Scenario Outline: Check user able to Get batch details by batch name
    ...
    Then User receives <statusCode> and with response body for get by batch name    
   ...
   Scenario Outline: Check user able to Get batch details by program Id
    ...
    Then User receives <statusCode> and with response body for get by prog Id  
